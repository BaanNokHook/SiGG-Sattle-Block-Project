...
server_map = {
    'main': "http://github-sigg-api-py.sattleblock",
    'test': "http://github-sigg-api-test-py.satteleblock"
}
...
def send(args):  
    ...
    if (args.channel in PAIF_API_CHANNELS):  
